...
- **Manual Launch**: `java -jar px-submission-tool-2.10.5.jar`
...
- **Windows**: `jre-windows\bin\java.exe -jar px-submission-tool-2.10.5.jar`
- **macOS**: `./jre-macos/Contents/Home/bin/java -jar px-submission-tool-2.10.5.jar`
- **Linux**: `./jre-linux/bin/java -jar px-submission-tool-2.10.5.jar`
...
```
px-submission-tool-2.10.5/
├── start.bat                        # Windows launcher
├── start.sh                         # Linux/macOS launcher
├── px-submission-tool-2.10.5.jar # Main application JAR
...
java -jar px-submission-tool-2.10.5.jar
```
...
### **Download Options**
- **Versioned releases**: `px-submission-tool-2.10.5.zip` (specific version)
