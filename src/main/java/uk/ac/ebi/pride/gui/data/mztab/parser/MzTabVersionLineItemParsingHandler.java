...
public abstract class MzTabVersionLineItemParsingHandler extends MetaDataLineItemParsingHandler {
    ...
    protected boolean doParseLineItem(MzTabParser context, String line, long lineNumber, long offset) throws LineItemParsingHandlerException {
        ...
        if ((lineItems.length == 3) && (lineItems[1].equals(MZTAB_VERSION_KEYWORD))) {
            ...
            return doProcessMztabVersion(MzTabParser context, String line, long lineNumber, long offset, line[2]);
        }
        return false;
    }

    // Delegate processing
    protected abstract boolean doProcessMztabVersion(MzTabParser context, String line, long lineNumber, long offset) throws LineItemParsingHandlerException;
}
