 ...
 * @version $Id$
 */
public class FileSelectionTableModel extends PxTableModel implements PropertyChangeListener {
    ...
    public Object getValueAt(int rowIndex, int columnIndex) {
        ...
        if (!dataFiles.isEmpty() && rowIndex >= 0 && columnIndex >= 0) {
            ...
            if (TableHeader.FILE_ID.getHeader().equals(getColumnName(columnIndex))) {
    ...
    public void setValueAt(Object aValue, int rowIndex, int columnIndex) {
        ...
        if (TableHeader.TYPE.getHeader().equals(getColumnName(columnIndex))) {
            DataFile dataFile = dataFiles.get(rowIndex);
