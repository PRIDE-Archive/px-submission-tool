 ...
 * @version $Id$
 */
public class SummaryResubmissionTableModel extends PxTableModel implements PropertyChangeListener {
    ...
    public SummaryResubmissionTableModel() {
    ...
    public Object getValueAt(int rowIndex, int columnIndex) {
        ...
        if (!dataFiles.isEmpty() && rowIndex >= 0 && columnIndex >= 0 && rowIndex < dataFiles.size() ) {
            ...
            if (SummaryResubmissionTableModel.TableHeader.FILE_ID.getHeader().equals(getColumnName(columnIndex))) {
            ...
            } else if (SummaryResubmissionTableModel.TableHeader.SIZE.getHeader().equals(getColumnName(columnIndex))) {
                return dataFile.getFileSize();
            } else if (SummaryResubmissionTableModel.TableHeader.ACTION.getHeader().equals(getColumnName(columnIndex))) {
    ...
    public void setValueAt(Object aValue, int rowIndex, int columnIndex) {
        ...
        if (SummaryResubmissionTableModel.TableHeader.ACTION.getHeader().equals(getColumnName(columnIndex))) {
            DataFile dataFile = dataFiles.get(rowIndex);
